...
public class GridWithDeleteColumn1 {
	...
	@Property
	// Oddly, in this example we have to persist the list, else on submit we get java.lang.IndexOutOfBoundsException.
	// But persisting a field in the session is not ideal because the field will be
	...
	@InjectPage
	private GridWithDeleteColumn2 _page2;
